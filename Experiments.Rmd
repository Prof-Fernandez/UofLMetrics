...
- Example: [Galileo Galilei Leaning Tower of Pisa experiment](https://ket.pbslearningmedia.org/resource/nvmm-math-fallingbodies/galileos-falling-bodies/)
...
A randomized experiment is designed and implemented consciously by social scientists. It entails conscious use of a treatment and control group with random assignment.
  ...
  - __Field experiments__ (Lab-in-the-field)
      - The effect of feedback on relative performance: ([Bagues et al, work in progress](https://www.manuelbagues.com/field_experiment%20-%20azmat,%20bagues,%20cabrales%20and%20iriberri%20-%202015.pdf)) __Yes Students work harder__
  - __Natural experiments__ 
    - has a source of randomization that is as if randomly assigned, but not part of real experiment.
    - Student feedback at a high school [Azmat and Iriberri 2010](https://www.sciencedirect.com/science/article/abs/pii/S0047272710000411) _Yes Students work harder__
    - Vietnam-era service effect on education and earnings ([Flory, Leibbrandt and List 2010](https://www.nber.org/papers/w16546)) __Women Shy away from competitive work settings__
...
Experiments provide a very transparent and simple empirical strategy. They solve the _selection bias_ problem. However, there still are some problems:
  1. Problems of implementation
      * Compliance and attrition
      * Cost, political issues (policy makers need to acknowledge ignorance),...
  2. Ethical issues
      * Note that the ethical argument is not obvious when 
      (i) the treatment cannot be applied to everybody (maybe due to some budget constraints) and 
      (ii) the optimal assignment rule is unknown.
  3. Hawthorne effect
      * The Illumination Experiment ([Landsberger 1950](https://youtu.be/o4XX90lqT6E?si=21JOdBvAwA5WkSWT), [Levitt and List 2011](https://www.aeaweb.org/articles?id=10.1257/app.3.1.224))

...
* But in some cases we might be interested in learning how entity characteristics (X's) influence a binary dependent variable.
* The dependent variable will represent a category.
  - How politicians vote on a bill?
  - Your choice to enter the labor market?
  - Your choice to buy a product?
  - How does a person's race affects loan approval?

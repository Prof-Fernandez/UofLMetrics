...
q = read.csv('https://www.aihr.com/wp-content/uploads/2018/01/turnover.csv', header = TRUE, sep = ",", na.strings = c("",NA))
```
...
plot(survfit(w), xlim = c(0, 12) , ylim = c(0.0, 1), col = c("red"), lwd = 3, xaxt='n', yaxt='n')
...
stargazer::stargazer(w1, type = "html", single.row = TRUE, star.char = c("a","b","c"), font.size = "tiny", covariate.labels = c("First Branch","Fourth Branch","Second Branch","Third Branch","Employment Agency","Job Sites","Referals","Social Media"))
```
</tiny>
...
plot(survfit(w, newdata=data.frame(pipeline = c('cs', 'ea','js','ref', 'sm'))) , xlim = c(0, 12) , ylim = c(0.0, 1),conf.int = FALSE, col = c("red", "blue", "yellow", "green", "grey1"), lwd = 4, xaxt='n', yaxt='n')
...
legend("bottomleft", legend=c('cs', 'ea','js','ref', 'sm'), col = c("red", "blue", "yellow", "green", "grey1"), cex = 1.5, lty = 1, pch = "",
...
stargazer::stargazer(w2,w3,type = "html", single.row = TRUE, star.char = c("a","b","c"), font.size = "tiny", covariate.labels = c("First Branch","Fourth Branch","Second Branch","Third Branch","Employment Agency","Job Sites","Referals","Social Media"))
```
...
w2 = survreg(Surv(exp, event) ~ . , data = q, dist = "weibul")
w3 = survreg(Surv(exp, event) ~ . , data = q, dist = "exponential")
stargazer::stargazer(w2,w3,type = "html", single.row = TRUE, star.char = c("a","b","c"), font.size = "tiny", covariate.labels = c("First Branch","Fourth Branch","Second Branch","Third Branch","Employment Agency","Job Sites","Referals","Social Media"),dep.var.labels.include = FALSE,model.numbers = FALSE)
```
</small>
---

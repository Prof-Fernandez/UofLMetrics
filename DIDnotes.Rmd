...
- $\beta_0$: Average change in y from the first to the second time period that is common to both groups

- $\beta_1$: Average difference in y between the two groups that is common in both time periods

- $\beta_2$: Average differential change in y from the first to the second time period of the treatment group relative to the control group
---

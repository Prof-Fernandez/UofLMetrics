...
- Acknowledgement: These notes are from an excellent blog post entitled, ["A Complete Tutorial on Time Series Modeling in R" by TAVISH SRIVASTAVA, DECEMBER 16, 2015](https://www.analyticsvidhya.com/blog/2015/12/complete-tutorial-time-series-modeling/)
...
- The year on year trend clearly shows that the number of passengers have been increasing without fail.
...
- MA model, noise / shock quickly vanishes with time. 
- AR model has a much lasting effect of the shock.
...
.pull-right[
![PACF](https://www.analyticsvidhya.com/wp-content/uploads/2015/02/Gradual-decline.gif)
.caption[
.center[PACF]
]
]

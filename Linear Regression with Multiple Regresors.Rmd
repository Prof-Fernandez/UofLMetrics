...
__Two important take aways: (1) there error has a mean of zero and (2) the error and X's are independent.
...
__Main takeaway: there should be no sample selection bias. The random sample should be a good representation of the population.__
...
stargazer(m4,m5,m6,type="html", covariate.labels = c("Female", "MidWest","South","West","Education*Female","Age","Age Squared","Education"),omit.stat = c("f","ser"), style = "qje", single.row=TRUE, star.char = c("a","b","c"))
```
</small>
---
class: center, middle, inverse

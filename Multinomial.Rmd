...
Let's look at the market for yogurt and the effects of advertising on sales. We have a dataset of individual customers, we know what yogurts they bought and what advertisements they have seen.
```{r message=FALSE, warning=FALSE}
library(Ecdat)
library(mlogit)
data(Yogurt)
YT <- mlogit.data(Yogurt,choice = "choice", shape = "wide",varying = c(2:9))
m1<-mlogit(choice ~ feat+price,data = YT)
```
---
## Conditional logit example
```{r echo=FALSE, results='asis'}
stargazer::stargazer(m1,type = "html", single.row = TRUE)
```
---
## Fixed Effect Logit
